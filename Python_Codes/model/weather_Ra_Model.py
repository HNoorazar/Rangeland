...
# %%
cattle_inventory = cattle_inventory[cattle_inventory.year.isin(list(county_annual_SW_Ra.year.unique()))]
...
# %%
cattle_inventory_cnty_missing_from_SW = [x for x in cattle_inventory.county_fips.unique()\
                                          if not(x in county_annual_SW_Ra.county_fips.unique())]
len(cattle_inventory_cnty_missing_from_SW)

# %%
SW_cnty_missing_from_cattle = [x for x in county_annual_SW_Ra.county_fips.unique()\
